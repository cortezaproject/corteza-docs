...
If you are editing a "company" record, and you wat to showi all the employees in that company, you would need to fill in: ${recordID} = companyId (companyId would need to be a field of the Record type insite the Employee module in this example).
