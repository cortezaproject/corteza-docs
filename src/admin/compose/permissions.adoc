...
After setting permission to an entire namespace, you can further define permissiones inside a namespace.
...
Like this you can create a role that has access to a certain module, but doen not have access to see and/or edit certain fields.
