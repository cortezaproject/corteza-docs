...
In order for the automation system to function properly, you are required to firstly setup {PRODUCT_NAME} server and all relevant front end web applications.
After that you have to setup {APP_AUTOMATION} server.

@todo; link to readmes?
...
If your knowledge of JavaScript is up to date, you can safely skip this section.
The rest of the sub section provides a quick overview of the important bits, and points you to external resources for further reading.
