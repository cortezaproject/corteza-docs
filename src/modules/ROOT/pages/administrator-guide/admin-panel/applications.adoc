...
. provide the requested data (see <<application-parameters>>),
. press the "Submit" button.

[IMPORTANT]
====
You can only define permissions for existing applications.
After you save the application, the option becomes available.
====
...
Basic information::
    *The necessary application information* such as the name and its status.
