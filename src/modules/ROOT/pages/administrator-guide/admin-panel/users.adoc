...
You can configure this with <<user-permissions-all>> or <<user-permissions-specific>>.
====
...
. provide the requested data (see <<user-parameters>>),
. press the "Submit" button.

[IMPORTANT]
====
You can only define permissions for existing users.
After you save the user, the option becomes available.
====
...
[TIP]
====
You can <<suspending-users,suspend the user>>.
====
