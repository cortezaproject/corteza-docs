...
Refer to the <<administrator-guide:compose:pages:page-builder>> section on details regarding the page builder.
====
...
[#administrator-guide:compose:pages:page-builder]
== Page builder
