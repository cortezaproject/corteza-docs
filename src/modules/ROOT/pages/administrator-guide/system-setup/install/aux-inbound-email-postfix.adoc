...
----
corteza_sink: "| curl --data-binary @- '{API_SYSTEM_BASE_URL}/system/sink?content-type=email&expires=&method=POST&origin=postfix&sign=6280d530ae74f1f9c55e4dd362c9ef2094221287'"
----
