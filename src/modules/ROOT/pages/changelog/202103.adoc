...
{PRODUCT_NAME} `2021.3` improves the stability and security of the system; and includes a lot of new features, including a visual automation builder (xref:2021.3@integrator-guide:workflows/index.adoc[{PRODUCT_NAME} {APP_NAME_WORKFLOW}]), support template management, and rendering.
...
`2021.3.6` temporarily reverts the change until it is addressed properly.
