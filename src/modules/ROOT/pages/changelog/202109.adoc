...
* Added a user interface to configure SMPT setting; such configuration does not require server restart ({SERVER_COMMIT_BASE}0b69d1a2[`0b69d1a2`], {WEBAPP_ADMIN_COMMIT_BASE}20a85d8[`20a85d8`]).
...
* Docs restyle https://github.com/cortezaproject/corteza-docs/commit/14550adf[14550adf].
...
* Error when corredor scripts are not loaded ({WEBAPP_COMPOSE_COMMIT_BASE}bb94645[`bb94645`]). 
* Disabled load button in chart edit ({WEBAPP_COMPOSE_COMMIT_BASE}6912fcd[`6912fcd`]). 
* Fix prefilter error on load in chart edit ({WEBAPP_COMPOSE_COMMIT_BASE}aeceb35[`aeceb35`]). 
