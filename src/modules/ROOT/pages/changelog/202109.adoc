...
*Contributors*: Tomaž Jerman (https://github.com/tjerman[GH]), Peter Grlica (https://github.com/petergrlica[GH]), Mia Arh (https://github.com/zmija[GH]), Denis Arh (https://github.com/darh[GH]), Katrin Yordanova (https://github.com/katrinDY[GH]), Jože Fortun (https://github.com/fajfa[GH]), Vivek Patel (https://github.com/vicpatel[GH]), Matija Rešek (https://github.com/resek[GH]), Bill Ewanick (https://github.com/billewanick[GH]), Mario Burazer (https://github.com/MarioBur[GH])
...
** the module field picker was completely reworked ({compose}8364da10[`8364da10`]).
//
...
* Defined a proper facility for testing API gateway handling logic ({SERVER_COMMIT_BASE}6ceadf40[`6ceadf40`]).
