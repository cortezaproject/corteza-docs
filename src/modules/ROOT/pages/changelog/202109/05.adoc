...
* The xref:devops-guide:cli/record-import.adoc[record import] via the import CLI command requires you to provide module field definitions along with the record import definitions.
...
* Added support for xref:devops-guide:cli/record-import.adoc[record import] via the import CLI command ({SERVER_COMMIT_BASE}96556f54[`96556f54`]).
