...
The support was added to allow provision of YAML files to configure record toolbar button visibility ({SERVER_COMMIT_BASE}05b97ee[`#05b97ee`]).
...
The structure was applied to the current RBAC access control service, the RBAC rule export and resource translations export services ({SERVER_COMMIT_BASE}0466ffe[`#0466ffe`], {SERVER_COMMIT_BASE}e7c1fe1[`#e7c1fe1`], {SERVER_COMMIT_BASE}a68ddf1[`#a68ddf1`], {SERVER_COMMIT_BASE}aef3171[`#aef3171`]).
