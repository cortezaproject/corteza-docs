...
With {PRODUCT_NAME} `2022.3`, we continue to improve system stability, security, and performance, as well as introducing new setup and development quality-of-life improvements.
...
To make the {PRODUCT_NAME} {APP_NAME_COMPOSE} app configuration process simpler, we introduce a few quality of life tweaks such as workflow step configuration preview tooltips, additional workflow help tooltips and labels, workflow step label suggestions, and a delete strategy for pages with sub-pages.
