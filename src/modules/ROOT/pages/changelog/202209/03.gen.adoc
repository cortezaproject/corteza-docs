...
This is why users have the ability to filter records using multi-value fields.
...
Also, for a better user experience and to always know the correct number of how many records/items we have.
...
The change was made to match the colors with those when confirming/denying the action to reject a privacy request.
