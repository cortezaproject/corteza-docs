...
The change was added to allow sorting of the first non-NULL value among the given columns into one column
...
A new page block on compose called Nylas was added, which can display Nylas components defined in the Nylas dashboard.
...
The change was made because we were incorrectly displaying the field names instead of their labels.
