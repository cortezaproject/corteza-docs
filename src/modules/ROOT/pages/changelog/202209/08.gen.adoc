...
The change was added to make reminders more user-friendly and easier to use by having the option to set a reminder for more than 24h and to have the option, to link a record to a reminder, and to un-dismiss a reminder if needed
