...
({WEBAPP_COMPOSE_COMMIT_BASE}450[`450`], {LOCALE_COMMIT_BASE}47e06eb[`47e06eb`]).
...
({_COMMIT_BASE}524[`524`], {_COMMIT_BASE}524[`524`]).
...
({_COMMIT_BASE}836[`836`]).
* Added support for bulk record updates.
The change was added to allow the users to update multiple records in a record list
({_COMMIT_BASE}906[`906`], {_COMMIT_BASE}906[`906`], {_COMMIT_BASE}906[`906`], {_COMMIT_BASE}906[`906`], {_COMMIT_BASE}906[`906`]).
...
({_COMMIT_BASE}670[`670`], {_COMMIT_BASE}670[`670`]).
...
({_COMMIT_BASE}921[`921`], {_COMMIT_BASE}921[`921`], {_COMMIT_BASE}921[`921`]).
...
({_COMMIT_BASE}955[`955`], {_COMMIT_BASE}955[`955`], {_COMMIT_BASE}955[`955`], {_COMMIT_BASE}955[`955`]).
...
({_COMMIT_BASE}968[`968`], {_COMMIT_BASE}968[`968`], {_COMMIT_BASE}968[`968`], {_COMMIT_BASE}968[`968`]).
...
({_COMMIT_BASE}1148[`1148`], {_COMMIT_BASE}1148[`1148`], {_COMMIT_BASE}1148[`1148`]).
* Added support for uploading ico files in record lists and file page blocks
({_COMMIT_BASE}1072[`1072`]).
...
({JS_COMMIT_BASE}73[`73`], {_COMMIT_BASE}760[`760`]).
...
({_COMMIT_BASE}775[`775`], {_COMMIT_BASE}775[`775`], {_COMMIT_BASE}775[`775`], {_COMMIT_BASE}775[`775`], {_COMMIT_BASE}775[`775`]).
* Added Route description field, Filters sorting, Profiler hits purging and Integration gateway settings
({_COMMIT_BASE}775[`775`], {_COMMIT_BASE}775[`775`]).
...
({_COMMIT_BASE}617[`617`], {_COMMIT_BASE}617[`617`]).
...
({_COMMIT_BASE}937[`937`], {_COMMIT_BASE}937[`937`]).
...
({_COMMIT_BASE}806[`806`], {_COMMIT_BASE}780[`780`], {_COMMIT_BASE}956[`956`], {_COMMIT_BASE}1136[`1136`], {_COMMIT_BASE}1129[`1129`], {_COMMIT_BASE}8379518[`8379518`], {_COMMIT_BASE}1069[`1069`], {_COMMIT_BASE}6ade044[`6ade044`], {_COMMIT_BASE}821[`821`], {_COMMIT_BASE}73a29b6[`73a29b6`], {_COMMIT_BASE}390a14e[`390a14e`], {_COMMIT_BASE}993[`993`], {_COMMIT_BASE}999[`999`]).
