...
The change was added to provide the user with an additional way to view the Select field value/values
...
The change was made to improve the user authentication interface and experience
