...
With {PRODUCT_NAME} `2023.3`, we continue to improve system stability, security, and performance, as well as focusing on improving our user interfaces to make {PRODUCT_NAME} more enjoyable to both use and configure.
...
In addition to changing the layout when the user visits the page, you can also define their relationship and allow users to navigate between them.
