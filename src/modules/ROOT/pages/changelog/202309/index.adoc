...
With {PRODUCT_NAME} `2023.9`, we focus primarily on user interface and customization -- both the user interface and data storage flexibility make {PRODUCT_NAME} easier to configure for a wide range of applications.
...
With `2023.9`, we introduce an automated mechanism to alter the storage location to support the module definition.
