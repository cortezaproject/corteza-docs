...
These are running automatically in the background, but if you have a longer sync delay or just want to test it, you can do it manually via sync cli command.
