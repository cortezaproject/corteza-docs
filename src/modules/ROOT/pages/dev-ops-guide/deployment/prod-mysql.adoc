...
[source,dotenv]
----
include::ROOT:example$docker-compose/prod-mysql/env-example.txt[]
----

.`docker-compose.yaml`
[source,yaml]
----
include::ROOT:example$docker-compose/prod-mysql/docker-compose.yaml[]
----
...
[source,shell]
----
include::ROOT:example$docker-compose/prod-mysql/output-ps.txt[]
----
