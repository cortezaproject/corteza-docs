...
[#dev-ops-guide:setup-local-demo]
...
See <<dev-ops-guide:nginx-proxy,Nginx Proxy>> and <<dev-ops-guide:setup-production,Production deployment>> for a production deploy.
====
