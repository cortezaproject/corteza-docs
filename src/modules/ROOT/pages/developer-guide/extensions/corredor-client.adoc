...
[#developer-guide:extensions:corredor-client:ui-hooks]
== UI hooks
...
Explicit::
    Explicit scripts are invoked by the user by explicitly invoking the above mentioned <<developer-guide:extensions:corredor-client:ui-hooks>>.
