...
[#developer-guide:extensions:automation-script-processing]
...
Parse client-scripts::
    ...
    Refer to <<developer-guide:extensions:client-script-bundling>> for details about creating bundles.
...
[#developer-guide:extensions:client-script-bundling]
...
When a change occurs, the server wil restart the entire <<developer-guide:extensions:automation-script-processing>> flow.
