...
In the settings page you can set multiple values that are used within Service Solution as default values.
You will need to enter this page when you have just installed {PRODUCT_NAME} and wish to use Service Solution.
...
== Steps to follow just installed {PRODUCT_NAME} Service Solution

. When you start using Service Solution, you first need to enter the "Settings" module.
+
...
.. If you don’t have a channel yet where you want to show Service Solution updates, create the channel with the (+) button.
...
+
It will look like: https://LINK-TO-YOUR-INSTANCE/compose/ns/service-solution/pages/117582846914252804/record/117585622083883012
+
You will need to copy "https://LINK-TO-YOUR-INSTANCE/compose/ns/service-solution/pages/117582846914252804/record" (so, everything except the last "/" and number), and paste it in the Default case link field.
