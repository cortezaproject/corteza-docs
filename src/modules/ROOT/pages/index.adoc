...
The DevOps guide also provides some miscellaneous bits, such as xref:devops-guide:references/configuration/server.adoc[system] and xref:devops-guide:references/configuration/corredor.adoc[{APP_AUTOMATION}] configuration references, additional deployment configurations (menu:DevOps guide[Offline deployment] and menu:DevOps guide[Online deployment]), xref:devops-guide:maintenance/backups.adoc[data backups], and xref:devops-guide:troubleshooting/index.adoc[troubleshooting].
