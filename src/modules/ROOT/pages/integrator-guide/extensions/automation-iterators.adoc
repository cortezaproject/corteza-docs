...
[#integrator-guide:extensions:automation-iterators]
...
----
<1> define the resource type; see <<integrator-guide:resources-events>> for details.
<2> define the event type; see <<integrator-guide:resources-events>> for details.
<3> define what action the script performs; see <<integrator-guide:extensions:automation-iterators:actions>> for details,
...
[#integrator-guide:extensions:automation-iterators:actions]
== Iterator actions
