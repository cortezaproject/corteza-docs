...
When writing automation scripts, these helpers are automatically provided via the execution context (more later in the <<integrator-guide:extensions:development:script>> section).
