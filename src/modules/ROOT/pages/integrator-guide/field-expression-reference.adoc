...
|*toUpper*      |`toUpper(string)`|The function converts all characters to uppercase.|`toLower("fOo")` toUpper in "FOO"
...
|*parseISOTime*     |`parseISOTime(datetime)`|The function returns parsed ISO DateTime string.|`parseISOTime(datefield)` results in "1970-01-01T00:00:00+00:00"
|*modTime*          |`modTime(datetime, duration)`|The function returns modified DateTime string.|`modTime(datefield, "+30m")` results in "1970-01-01T00:30:00"
