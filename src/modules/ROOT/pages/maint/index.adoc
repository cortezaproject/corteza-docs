...
.Frontend applications
 ...
 - {GIT_REPO_LINK_PREFIX}-webapp-compose[{APP_NAME_COMPOSE}] is a https://en.wikipedia.org/wiki/Low-code_development_platform[low-code development platform] and allows creation of record-based business applications
