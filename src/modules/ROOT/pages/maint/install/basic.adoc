...
[source,dotenv]
----
include::example$docker-compose/basic/env.txt[]
----

.`docker-compose.yaml`
[source,yaml]
----
include::example$docker-compose/basic/docker-compose.yaml[]
----
...
[source,shell]
----
include::example$docker-compose/basic/output-ps.txt[]
----
