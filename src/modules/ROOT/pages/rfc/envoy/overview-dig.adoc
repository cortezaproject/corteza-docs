.The diagram outlines the entire Envoy framework, all of it's layers, their inputs, and their outputs. Refer to the following sections to get more insight into the entire thing.
