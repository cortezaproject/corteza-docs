...
|rel_module_orig|federation module id on source node (id in federation_module_upstream)
|field_mapping|json field mappings
|===
...
|fields|json field mappings, ex: [{ source: 'node_A_module_field_7', dest: 'node_B_module_field_2', transform: 'string' }]
|===
