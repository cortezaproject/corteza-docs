...
The administrator guided covers the process of performing administration tasks such as defining roles and role membership, configuring your security model, and monitoring the system.
...
* inspecting xref:logging.adoc[log] and xref:automation.adoc[automation] contents to identify and solve configuration issues.
...
image::corteza-one-app-selector.png[role="data-zoomable"]
...
Click on the btn:[permissions] button on the top of the list to see all of the available access control rules.
...
image::webapp-compose-app-homepage.png[role="data-zoomable"]
...
[NOTE]
====
The administrator guide doesn't touch low-code app configuration.
