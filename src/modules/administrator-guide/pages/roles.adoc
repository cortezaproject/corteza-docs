...
image::role-list.png[role="data-zoomable"]
...
image::role-create.png[role="data-zoomable"]
...
image::role-edit.png[role="data-zoomable"]
...
.The screenshot shows clone permissions button.
image::role-clone-permissions-button.png[role="data-zoomable"]
