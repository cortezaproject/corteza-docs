...
. you can also run `git clone https://github.com/cortezaproject/corteza-js.git` command
=== Assure dependencies
...
Run the `yarn link` command to make this package linkable. In corteza-vue and corteza-webapp-* use `yarn link @cortezaproject/corteza-js` command to link this package to them. 
