...
It also makes the text *shorter*, *more undertsndable* and *more comfortable to read* than any other tense does.
...
Aditionally, it removes you, the creator, from the text, which is something you should be going for.
