...
*Don't go over the top* with images by showing every single step of the way or even worse by just pasting a screenshot *with no context* of what we are looking at.
