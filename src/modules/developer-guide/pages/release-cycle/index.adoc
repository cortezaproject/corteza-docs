...
|
The major versions (referred to as a release) occur twice per year: the last weeks of March and September (previously quarterly with an additional release in June and December).
