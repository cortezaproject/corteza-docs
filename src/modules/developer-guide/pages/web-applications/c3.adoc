...
{PRODUCT_NAME} Component Catalogue (C3) is a tool for building UI components in an insulated environment, making it easier to develop independent components.
...
To exemplify; the `Button.vue` component should define the `Button.c3.js` configuration file.
