...
Refer to the https://github.com/cortezaproject/corteza-webapp-admin/blob/{VERSION}/src/dev-env.js[corteza-webapp-admin; /src/dev-env.js] for an example configuration.
...
Refer to the https://github.com/cortezaproject/corteza-webapp-admin/blob/{VERSION}/src/components/C3.js[corteza-webapp-admin; /src/components/C3.js] for an example configuration
