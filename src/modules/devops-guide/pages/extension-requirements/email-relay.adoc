...
You can implement automatic responses, create records based on the email content, and forward the email to our supervisor.

[NOTE]
====
Here, we only cover how to setup an email relay.
Refer to the xref:integrator-guide:index.adoc[integrator guide] for details on using this feature.
====
