...
Sends samples of all authentication notification to recipients.
//Editor's note: or 'a recipient'. Fix according to what is most accurate.
...
Provision tasks
//Editor's note: Add more information.
...
//Editor's note: Add more information. Check for accuracy.
