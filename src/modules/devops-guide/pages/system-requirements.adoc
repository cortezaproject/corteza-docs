...
= System requirements
:description: A baseline to determine the system requirements needed to run {PRODUCT_NAME}.
:keywords: dev-ops, devops, {PRODUCT_NAME}, system requirements, requirements
...
[NOTE]
====
If you aren't using any other HTTP server, we highly recommend using the use of https://github.com/jwilder/nginx-proxy[Nginx Reverse Proxy] and https://github.com/JrCs/docker-letsencrypt-nginx-proxy-companion[LetsEncrypt companion container for nginx-prox].
