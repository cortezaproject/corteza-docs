...
The 'AUTH DEFAULT CLIENT' environment variable, often referred to as  `corteza-webapp`, specifies the handle of the default client, which is an authentication client.
