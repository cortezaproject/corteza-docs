...
= Troubleshooting
:page-aliases: 2022.9@maintenance/troubleshooting.adoc
...
== Changes to the Default Auth-Client Settings not Visible

The `AUTH_DEFAULT_CLIENT` environment variable, often referred to as  `corteza-webapp`, specifies the handle of the default client, which is an authentication client.
