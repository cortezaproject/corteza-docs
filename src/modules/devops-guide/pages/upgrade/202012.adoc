...
//Editor's note: 'those' referring to what? What does the choice to not make an automated upgrade mean for the user?
It's not possible to know what kind of changes you might have made in your modules.
//Editor's note: How does that relate to the above? Expand on why that is important to note.
