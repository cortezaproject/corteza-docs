...
The price book page is accessible by clicking on the menu:Products[Price book] in the main navigation bar on the top of the screen.
...
=== The addition of a new price book entry
