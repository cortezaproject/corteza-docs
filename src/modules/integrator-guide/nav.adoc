...
***** xref:authentication/external/saml/azure.adoc[Azure]
...
*** xref:security-model/user-groups.adoc[]
*** References
...
***** xref:automation/workflows/examples/notifications.adoc[]
***** xref:automation/workflows/examples/integration-gateway-file-upload.adoc[]
***** xref:automation/workflows/examples/attaching-files.adoc[]
...
**** Examples
***** xref:automation/automation-scripts/examples/local-setup.adoc[]
***** xref:automation/automation-scripts/examples/explicit-server-script.adoc[]
