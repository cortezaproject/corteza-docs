...
Permissions granted to authenticated and anonymous users belong to the Authenticated user and Anonymous user roles. When setting up the corteza instance, an Administrator role is assigned all permissions on your site.
...
It is good practice to make several roles in your {PRODUCT_NAME} instance. You might want the following roles on your {PRODUCT_NAME} instance.
