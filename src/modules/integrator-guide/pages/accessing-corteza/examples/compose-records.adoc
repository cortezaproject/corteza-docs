...
If you wish to update only specific fields, firstly fetch the original record, change the desired values, and then update the record.

The fields you omit in the request will be removed from the record (value sanitation, automation, and other system processes may still define the value).
