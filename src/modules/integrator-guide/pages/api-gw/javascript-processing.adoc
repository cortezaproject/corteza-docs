...
Click on the btn:[processing] tab in tje filter list and select the btn:[payload processor] option.
...
When you add the payload processor a popup opens presenting the editor .
