...
An *auth client* offers a high-level access control over the use of {PRODUCT_NAME} API and it's resources.
...
Base configuration parameters allow you to identify the auth client as well as specify the validity and the scope the auth client provides.
