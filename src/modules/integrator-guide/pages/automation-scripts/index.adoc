...
Refer to xref:automation-scripts/references/resource-events.adoc[resources and events] for a complete list of events you can listen for.
...
Refer to xref:automation-scripts/references/resource-events.adoc[resources and events] for a complete list of available resources and supported events.
...
[NOTE]
====
Refer to xref:automation-scripts/references/resource-constraints/index.adoc[resource constraints] for a list of available constraint properties for each resource.
====
