...
To exemplify; you press a button, therefore you are the invoking user.
...
To exemplify; you can prevent regular users from signing documents or sending quotes.
