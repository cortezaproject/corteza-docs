...
[NOTE]
====
If you want to wait for an action performed by a user (such as a confirmation), use a xref:automation/workflows/index.adoc#user-interaction[prompt step] instead.
====
...
|
An interval trigger allows you to run the workflow in the specified interval.
...
|
A timestamped trigger allows you to run the workflow at the specified time.
