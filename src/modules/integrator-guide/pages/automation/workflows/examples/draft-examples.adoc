...
image::workflow/examples/module.png[role="data-zoomable"]

The link:{attachment-path}examples/module.json[source code] for the module example.

The records used for the examples:

image::workflow/examples/records.png[role="data-zoomable"]
...
image::workflow/examples/wf.png[role="data-zoomable"]

The link:{attachment-path}examples/records-no-filter.json[source code] for the workflow example.
...
The link:{attachment-path}examples/records-simple-filter.json[source code] for the workflow example.
...
The link:{attachment-path}examples/records-range-filter.json[source code] for the workflow example.
...
The link:{attachment-path}examples/records-age-filter.json[source code] for the workflow example.
...
image::workflow/examples/iterator-wf.png[role="data-zoomable"]

The link:{attachment-path}examples/records-iterator-regular.json[source code] for the workflow example.
...
image::workflow/examples/iterator-nested-wf.png[role="data-zoomable"]

The link:{attachment-path}examples/records-iterator-nested.json[source code] for the workflow example.
...
image::workflow/examples/manual-wf.png[role="data-zoomable"]

The link:{attachment-path}examples/page-button.json[source code] for the workflow example.
...
image::workflow/examples/pageblock-automation-add.png[role="data-zoomable"]

=== Using it

Open up the page the button resides on and click it.

image::workflow/examples/pageblock-automation-pressed.png[role="data-zoomable"]
