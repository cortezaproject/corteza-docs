...
There is a pane where you can input different arguments on the left side of the screen. 
Click the dropdowns, enter the ID parameter, and select a sub-workflow.

To save the changes, select the pop-up notification that displays on the left side of the screen.
