...
To help you maintain and expand on larger projects, we've prepared a document outlining the xref:automation/workflows/style-guide-best-practices.adoc[style guide and best practices].
