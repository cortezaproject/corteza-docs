...
[IMPORTANT]
====
Non-primitive data types (more can be found xref:automation/workflows/types.adoc[here]) are passed around using pointers, meaning that any change to one reflects to all of the copies.
