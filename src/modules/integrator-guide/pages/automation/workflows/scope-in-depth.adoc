...
{
  "image": {
    "rel": "automation/workflows/scope-in-depth/gateway_scope_base.png",
    "alias": "automation-workflows-scope-in-depth-gateway_scope_base.png",
    "w": 1442,
    "h": 684
  },
  "view": {},
...
{
  "image": {
    "rel": "automation/workflows/scope-in-depth/loop_scope_base.png",
    "alias": "automation-workflows-scope-in-depth-loop_scope_base.png",
    "w": 1043,
    "h": 1084
  },
  "view": {},
