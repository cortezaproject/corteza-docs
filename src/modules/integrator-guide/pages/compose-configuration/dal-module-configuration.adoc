...
The connection is enabled through selecting a database to connect to(the connection can either be primary or an external database) and also specifying the name of the database table or collection where records can be accessed and stored.
