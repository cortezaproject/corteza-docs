...
Refer to the source code for details on https://github.com/cortezaproject/corteza-server/blob/2021.9.x/compose/service/values/sanitizer.go#L228[regular date time inputs] and https://github.com/cortezaproject/corteza-server/blob/2021.9.x/compose/service/values/sanitizer.go#L208[time only inputs].
