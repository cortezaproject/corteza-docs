...
Refer to the xref:compose-configuration/sanitization-validation.adoc[] for more details.
...
Refer to the xref:ql.adoc[QL reference] for details regarding filter definition.
