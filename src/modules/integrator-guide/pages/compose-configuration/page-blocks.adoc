...
//Editor's note: One or more external websites? If one, leave it as it is, if more is possible, change "an external website" into "one or more external websites".
...
//Editor's note: What does "They" refer to? Make sure the reference of They is clear and understood.
