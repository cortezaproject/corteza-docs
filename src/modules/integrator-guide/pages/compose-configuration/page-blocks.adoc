...
image::compose-configuration/page-block-reference/config-record-revisions.png[...,50%,role="preview data-zoomable"]
...
image::compose-configuration/page-block-reference/config-record-revisions-on-demand.png[...,50%,role="preview data-zoomable"]
