...
The data privacy officer console is a user interface that is feature enabled to allow a dpo to have access to privacy requests from other users concerning the treatment of their personal data.
