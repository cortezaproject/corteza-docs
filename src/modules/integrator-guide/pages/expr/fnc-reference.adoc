...
|*random*  |`random(number, ...number)`|The function returns random number and also between range if given|`random(5)` returns 3.023301439898098, `random(5, 10)` returns 8.023301439898098
|===
...
|*sub*              |`sub(datetime, datetime)`|The function returns duration between 1st DateTime to 2nd DateTime into Milliseconds.|`sub(datefield1, datefield2)` results in "86400000"
|===
