...
//Editor note: add the documentation as necessary
...
Refer to the xref:compose-configuration/index.adoc[field expressions] sub section to learn how you can define xref:compose-configuration/index.adoc#value-expressions[value expressions (formula fields)], custom xref:compose-configuration/index.adoc#value-sanitizers[value sanitizers] and xref:compose-configuration/index.adoc#value-validators[validators].
...
====
//Editor note: add instructions on how to set up! (line 73)
...
====
//Editor note: add a reference to the endpoint! (line 87)
