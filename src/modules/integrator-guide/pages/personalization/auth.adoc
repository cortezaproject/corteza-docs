...
The `/public` subdirectory contains the assets you can use in your authentication screens, such as images and stylesheets.
...
The `/templates` subdirectory contains the HTML templates that are used when displaying the authentication screens.
