...
[NOTE]
====
*DevNote* define a complete list of namespaces and what contents they should hold?
====
...
Refer to the https://github.com/cortezaproject/corteza-locale/blob/22491ad6cb1a317efef9aed73dc94d68d367f6d5/src/schema/config.json[`schema/config.json`] file for details.
