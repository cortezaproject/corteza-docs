...
= The Security Model
:page-aliases: administrator-guide:access-control/index.adoc
...
[NOTE]
====
Most of the {PRODUCT_NAME} resources allow you to define what xref:security-model/roles.adoc[roles] are allowed to access the resource.
...
Resource specificity is defined based on _how specific is this rule to this resource_.
