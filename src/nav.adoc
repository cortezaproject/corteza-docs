...
** xref:integrator-guide/resource-events-reference/index.adoc[Resource Events]
...
** xref:extensions/crm/index.adoc[CRM]
** xref:extensions/service-solution/index.adoc[Service Solution]
