...
{PRODUCT_NAME} makes Messaging your colleagues intuitive and user friendly.
...
To upload the file click on the plus icon (+) in the left corner of the messaging input and select the file or simply drag and drop the file to the channel.
